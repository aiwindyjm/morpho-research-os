...
| Cross-language fixture loaders | `powershell -File tests/fixtures-support/run-fixture-checks.ps1` (Node `--test`, Python unittest, and cargo loader suites) | Tri-language loader parity on the golden fixtures | Active (`contracts.yml`) |
